    ...
    return (
        <dialog id="my_modal_1" className="modal">
            <div className="modal-box">
                <h3 className="font-bold text-lg text-center">F1</h3>
                <label className="input input-bordered flex items-center gap-2 mt-10 mb-4">
                ...
                <div className="text-lg mt-5 text-blue-600">
